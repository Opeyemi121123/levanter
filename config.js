...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_2358f13e79a0624f44a3eed65c7ca8372e').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '2349073905236',
  ...
  GROUP_ADMINS: process.env.GROUP_ADMINS || 'Opeyemi',
  RENDER_NAME: (process.env.RENDER_NAME || 'Opeyemi').trim(),
